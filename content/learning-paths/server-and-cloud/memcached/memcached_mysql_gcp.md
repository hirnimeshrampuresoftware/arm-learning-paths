...
The hosts file is automatically generated and does not need to be changed.
...
```output
ubuntu@ip-172-31-38-39:~/gcp-mysql$ ansible-playbook playbook.yaml -i /tmp/inventory

...
```console
ansible-playbook playbook.yaml -i /tmp/inventory --key-file ~/.ssh/id_rsa
```
...
```output
ubuntu@ip-172-31-38-39:~/azure-mysql$ ansible-playbook playbook.yaml -i /tmp/inventory --key-file ~/.ssh/id_rsa

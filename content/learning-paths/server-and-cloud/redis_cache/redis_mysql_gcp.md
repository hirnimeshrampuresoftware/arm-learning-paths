...
You can use the same `playbook.yaml` file used in the section, [Deploy Redis as a cache for MySQL on an AWS Arm based Instance](/learning-paths/server-and-cloud/redis_cache/redis_cache_aws#configure-mysql-through-ansible).
...
Follow the instructions given in this [documentation](/learning-paths/server-and-cloud/redis_cache/redis_cache_aws#connect-to-database-from-local-machine) to connect to the database from local machine.

## Deploy Redis as a cache for MySQL using Python

Follow the instructions given in this [documentation](/learning-paths/server-and-cloud/redis_cache/redis_cache_aws#deploy-redis-as-a-cache-for-mysql-using-python) to deploy Redis as a cache for MySQL using Python.
